...
{
    /// <summary>
    /// An implementation of <see cref="IValueConverter"/> that converts <see cref="DateTime"/>s between specified 
    /// <see cref="DateTimeKind"/>s.
    /// </summary>
    /// <remarks>
    /// <para>
    /// The <c>DateTimeConverter</c> can be used to convert <see cref="DateTime"/>s between different 
    /// <see cref="DateTimeKind"/>s as required by the source and target of a data binding. The <see cref="SourceKind"/> 
    /// specifies the <see cref="DateTimeKind"/> that the source stores the <see cref="DateTime"/> in, whilst the 
    /// <see cref="TargetKind"/> specifies the <see cref="DateTimeKind"/> that the target stores the <see cref="DateTime"/> 
    /// in.
    /// </para>
    /// <para>
    /// If <see cref="DateTimeKind.Unspecified"/> is assigned to either <see cref="SourceKind"/> or 
    /// <see cref="TargetKind"/> then no conversion will take place in that direction.
    /// </para>
    /// </remarks>
    /// <example>
    ...
    /// </example>
    /// <example>
    /// The following example shows how a <c>DateTimeConverter</c> can be used to convert <c>DateTime</c>s to local time 
    /// for the user, but convert them back to UTC time before storing them in the bound object:
    /// <code lang="xml">
    /// <![CDATA[
    ...
    /// <example>
    /// The following example shows how a <c>DateTimeConverter</c> can be used to convert <c>DateTime</c>s to local time 
    /// without adjusting the underlying value of the <c>DateTime</c>:
    /// <code lang="xml">
    /// <![CDATA[
    ...
    public class DateTimeConverter : IValueConverter
    {
        ...
        /// <remarks>
        /// <para>
        /// This property specifies what type of <see cref="DateTime"/> is required for the binding source. Any 
        /// <see cref="DateTime"/>s converted before being applied to the source will be converted to the kind specified 
        /// by this property.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>
        /// This property specifies what type of <see cref="DateTime"/> is required for the binding target. Any 
        /// <see cref="DateTime"/>s converted before being applied to the target will be converted to the kind specified
        /// by this property.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>
        /// This property can be used to ensure that any <see cref="DateTime"/> heading to the source of the binding 
        /// will be adjusted according to the specified <see cref="TimeSpan"/>.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>
        /// This property can be used to ensure that any <see cref="DateTime"/> heading to the target of the binding 
        /// will be adjusted according to the specified <see cref="TimeSpan"/>.
        /// </para>
        /// </remarks>
        ...
        /// <summary>
        /// Gets or sets a value indicating how <see cref="DateTime"/>s are converted between the <see cref="SourceKind"/> 
        /// and <see cref="TargetKind"/>.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// <see cref="DateTimeConversionMode.SpecifyKindOnly"/>, the value of the <see cref="DateTime"/> is not adjusted 
        ...
        /// </summary>
        /// <param name="conversionMode">Conversion mode.</param>
        /// <param name="dateTime">The time to convert.</param>
        /// <param name="convertTo">The kind of conversion.</param>
